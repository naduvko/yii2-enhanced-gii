...
//    }
            ...
            foreach ($db->getSchema()->getTableSchemas($schemaName) as $table) {
                ...
                foreach ($table->foreignKeys as $refs) {
                    ...
                    $relations[$table->fullName][lcfirst($relationName)] = [
                        self::REL_TYPE => "return \$this->hasOne(\\{$this->nsModel}\\$refClassNameclass, $link);", // relation type
                    ...
                    $relations[$refTableSchema->fullName][lcfirst($relationName)] = [
                        self::REL_TYPE => "return \$this->" . ($hasMany ? 'hasMany' : 'hasOne') . "(\\{$this->nsModel}\\$classNameclass, $link);", // rel type
    ...
    private function generateManyManyRelations($table, $fks, $relations)
    {
        ...
        $relations[$table0Schema->fullName][$relationName] = [
            "return \$this->hasMany(\\{$this->nsModel}\\$className1class, $link)->viaTable('"
        ...
        $relations[$table1Schema->fullName][$relationName] = [
            "return \$this->hasMany(\\{$this->nsModel}\\$className0class, $link)->viaTable('"
            . $this->generateTableName($table->name) . "', $viaLink);",
            $className0,
            true,
        ];
